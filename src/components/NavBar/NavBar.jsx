            ...
            <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        {/* Try Pro Free button - visible on ALL screen sizes */}
                        {!isPro && (
                            <button
                                onClick={() => navigate('/pricing')}
                                className="bg-gradient-to-r from-yellow-400 to-orange-400 hover:from-yellow-500 hover:to-orange-500 text-slate-900 font-bold px-4 py-2 rounded-lg transition-all transform hover:scale-105 shadow-lg text-sm whitespace-nowrap"
                            >
                                Try Pro Free
                            </button>
                        )}
