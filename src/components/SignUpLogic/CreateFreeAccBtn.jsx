...
function CreateFreeAccBtn() {
    ...
    return (
        <>         
            <button 
                className="inline-block border border-violet-500 text-violet-300 px-6 py-3 rounded-lg hover:bg-violet-600/10 transition-colors text-center"
                onClick={handleSignIn} // No need for an anonymous function here if handleSignIn directly called
                disabled={authLoading}
            >
                {authLoading ? 'Loading...' : 'Create Free Account'}
            </button>
...
export default CreateFreeAccBtn;