...
// All available avatars in your game
const ALL_AVATARS = [
  // Free avatars
//   { id: "default", name: "Default", isPremium: false },
  { id: "warrior_01", name: "Warrior", isPremium: false },
//   { id: "mage", name: "Mage", isPremium: false },
//   { id: "archer", name: "Archer", isPremium: false },
//   { id: "rogue", name: "Rogue", isPremium: false },
//   { id: "paladin", name: "Paladin", isPremium: false },
  
  // Premium avatars
  { id: "knight-idle", name: "Knight", isPremium: true },
//   { id: "dragon-warrior", name: "Dragon Warrior", isPremium: true },
//   { id: "shadow-assassin", name: "Shadow Assassin", isPremium: true },
//   { id: "fire-mage", name: "Fire Mage", isPremium: true },
//   { id: "holy-crusader", name: "Holy Crusader", isPremium: true },
//   { id: "ice-sorcerer", name: "Ice Sorcerer", isPremium: true },
];
    ...
    return (
        ...
        <div>
            ...
            {ALL_AVATARS.map((avatar) => (
                ...
                {/* Premium Badge - subtle indicator */}
                {avatar.isPremium && (
        ...
        <style>{`
            ...
            to { background-position: -672px 0px; }
            }
            
            .knight-idle-tiny {
            width: 48px;
            height: 40px;
            background-image: url('/images/premium-avatars/knight-idle.png');
            background-repeat: no-repeat;
            background-position: 0 0;
            background-size: 384px 40px;
            animation: knight-idle 0.7s steps(7) infinite;
