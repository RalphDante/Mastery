                    ...
                    {!showAIOption ? 
                        ((!loading && (!folders || folders.length === 0)) ? (
                            ...
                            <button 
                                ...
                                className={`group ${hasNotStartedAFlashcardSession ? 'animate-pulse' : ''} relative overflow-hidden bg-gradient-to-br from-red-600 to-orange-600 rounded-xl p-6 hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-red-500/50`}
                            >
                            ...
                            <div className="col-span-1 md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                >
                                    ...
                                    <div className="absolute -bottom-4 -right-4 text-8xl opacity-10 group-hover:opacity-20 transition-opacity">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-20 h-auto" viewBox="0 0 512 512"><path fill="currentColor" d="M250.53 22.03c-57.055 45.157-80.673 37.81-100.31.22c16.598 61.517 10.408 66.415-44.72 116.594c67.324-35.666 96.206-34.238 130.97 7.187c-34.906-53.112-30.954-75.35 14.06-124zm18.407.126l11.688 114.938l-99.875 58.094l97.75 21.093c-9.58 8.352-20.214 19.028-31.28 30.095l-.032.03L18.563 472.438v19.438h32.156L273.343 272.5c10.26-10.263 18.902-19.538 25.78-27.75l18.938 87.75l58.094-99.875l114.938 11.688l-77.03-86.094l46.655-105.69l-105.69 46.657l-86.092-77.03zM26.875 55.938c33.765 27.66 35.21 42.767 30.75 87.78c18.975-53.73 27.964-67.297 64.5-82C82.972 71.094 66.21 73 26.875 55.94zm54.75 102.406c24.955 27.012 26.97 43.684 24.25 72.062c14.775-34.45 22.072-45.66 55.625-64.312c-34.56 11.183-45.5 10.22-79.875-7.75m325.594 95c9.27 51.694-4.61 73.708-32.845 106.687c43.3-37.043 57.852-44.284 96.844-38.75c-38.597-11.457-47.426-20.624-64-67.936zm-55.658 72.812c-18.705 68.79-45.304 83.944-107.625 70.125c54.126 20.1 56.34 21.07 53.532 85.25c24.757-55.42 46.49-52.217 95.06-37.217c-41.775-31.838-45.71-48.97-40.967-118.157zm109.344 55.97c-15.32 17.994-22.932 17.49-43.812 9.343c22.828 18.444 17.596 34.024 10.844 59.405c16.05-19.12 23.516-25.237 50.312-12.688c-22.86-21.342-27.13-29.857-17.344-56.062z"/></svg>
                                    </div>
                                </button>
                                ...
                                >
                                    ...
                                    <div className="relative z-10 flex flex-col items-center justify-center space-y-4">
                                        <div className="text-6xl">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-auto" viewBox="0 0 24 24"><path fill="#fff4e6ff" d="m21.71 20.29l-1.42 1.42a1 1 0 0 1-1.41 0L7 9.85A3.8 3.8 0 0 1 6 10a4 4 0 0 1-3.78-5.3l2.54 2.54l.53-.53l1.42-1.42l.53-.53L4.7 2.22A4 4 0 0 1 10 6a3.8 3.8 0 0 1-.15 1l11.86 11.88a1 1 0 0 1 0 1.41M2.29 18.88a1 1 0 0 0 0 1.41l1.42 1.42a1 1 0 0 0 1.41 0l5.47-5.46l-2.83-2.83M20 2l-4 2v2l-2.17 2.17l2 2L18 8h2l2-4Z"/></svg>
                                        </div>
                                        <h3 className="text-2xl font-bold text-white text-center">Create Manually</h3>
